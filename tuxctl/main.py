...
from tuxctl.packages.main import find_package_file
from tuxctl.packages.main import install_package
        ...
        if len(sys.argv) < 3:
            ...
            if action == "install":
                ...
                if response.status_code == 200:
                    ...
                    install_package(target, response)
